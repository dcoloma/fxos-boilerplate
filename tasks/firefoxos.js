...
module.exports = function (grunt) {
   ...
   * the app should be available at the this.data.appPath that is typically
   * the app folder in the root of the project
   */
   ...
   * The application is identified by the appId that corresponds to the 
   * origin that has been set for it
   */
  ...
  */
  ...
  /* Ensures ports are forwarded so we can connect to the device via adb */
